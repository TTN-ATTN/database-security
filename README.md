...
📂 **Tài liệu kèm**: [proposal.md](proposal.md) (thiết kế gốc) · [data_flow.md](data_flow.md) (đường đi query per-role) · [shining_point.md](shining_point.md) (15 điểm làm tốt — defense for viva) · [problem.md](problem.md) (sự cố đã gặp) · [future_work.md](future_work.md) (limitation + lộ trình production-readiness) · [demo/CLEANUP.md](demo/CLEANUP.md) (sau demo).
